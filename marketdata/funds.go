...
type FundManager struct {
	...
	TenureReturn NullDecimal `json:"tenure_return"`
	TenureYears  NullDecimal `json:"tenure_years"`
...
type FundHolding struct {
	...
	HeldPercent       NullDecimal `json:"share_held_pct"`
	HeldChangePercent NullDecimal `json:"share_held_chg_pct"`
...
type FundNetValue struct {
	...
	NetValue Decimal `json:"net_value"`
}
...
type FundPerformance struct {
	Currency       string      `json:"currency"`
	EndDate        Time        `json:"end_date"`
	Return1M       NullDecimal `json:"return_1m"`
	Return3M       NullDecimal `json:"return_3m"`
	Return6M       NullDecimal `json:"return_6m"`
	Return1Y       NullDecimal `json:"return_1y"`
	Return3Y       NullDecimal `json:"return_3y"`
	Return5Y       NullDecimal `json:"return_5y"`
	Return10Y      NullDecimal `json:"return_10y"`
	SinceInception NullDecimal `json:"return_si"`
}
