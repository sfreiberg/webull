...
> except where the [compatibility matrix](docs/COMPATIBILITY.md) says
> otherwise. Funds, screeners, watchlists, news, streaming and the Connect
> API are not yet implemented. The public API may change without notice
> until v1.0.0.
